...
public class Trees : MonoBehaviour
{
    ...
    float deathDPS = 0.5f; //dps to overall health
    static float deathTime = 11f; //need to be same as maxhealth
    float dpsTree = 1f; 
	
    bool isDead = false; //animator
    bool isDamaged = false; //animator
